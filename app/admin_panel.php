...
<?php
$seoparams = d()->Seoparam->where('`page_url`=?', urldecode($url = $_SERVER['REQUEST_URI']));
if ($seoparams->ne) { ?>
	<li><a target="_blank" href="/admin/edit/seoparams/<?php print $seoparams->id; ?>">Параметры страницы</a></li>
<?php
} else { ?>
	<li><a target="_blank" href="/admin/edit/seoparams/add?page_url=<?php print h($url); ?>">Параметры страницы</a></li>
<?php
} ?>
